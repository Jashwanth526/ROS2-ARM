...
: ${AMENT_CURRENT_PREFIX:="/home/jashwanth/arduinobot_ws/install/arduinobot_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/arduinobot_controller/environment/pythonpath.sh"
